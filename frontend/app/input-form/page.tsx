    ...
    const handleSubmit = async (e?: React.FormEvent) => {
        ...
        try {
            ...
            // Example structure for connecting to your AI backend:
                        const reportData = await runAudit({
                name: form.name,
                domain: form.domain,
            ...
            sessionStorage.setItem("strazh_last_report", JSON.stringify(reportData));
                                                ...
                                                {currentStep === 0 && (
                                                    <div className="space-y-6">
                                                        ...
                                                        <motion.div variants={fadeInUp} className="form-group">
                                                            ...
                                                            <input id="country" type="text" className="form-input" placeholder='e.g. "DE" or "US"' value={form.country} onChange={(e) => setForm({ ...form, country: e.target.value })} />
</motion.div>
